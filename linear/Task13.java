...
public class Task13 {
	...
	/* Heron's formula */
	areaOfTriangle = Math.sqrt(halfOfPerimeter
			 * (halfOfPerimeter - lengthA)
			 * (halfOfPerimeter - lengthB)
			 * (halfOfPerimeter - lengthC));
	
	System.out.println("Perimeter of the given triangle: "
			   + perimeterOfTriangle);
	System.out.println("Area of the given triangle: "
			   + areaOfTriangle);	
    }
}
